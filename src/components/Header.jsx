...
// logo
import logo from '../assets/tripCab_logo.png';

const Header = () => {
  return (
    <>
      <header className="w-full sticky top-0 shadow-lg z-40" style={{ backgroundColor: '#fac02e' }}>
        <div className="flex justify-between items-center mx-4 p-0.5">
          <div className="flex items-center">
            {/* Add logo here */}
            <img src={logo} alt="Logo" className="h-auto  max-w-[95px] cursor-pointer" />
          </div>
